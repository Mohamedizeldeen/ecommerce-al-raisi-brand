@unless (request()->cookie('age_verified'))
    <div class="fixed inset-0 z-[60] flex items-center justify-center bg-ink/95 px-4">
        <div class="max-w-md bg-white p-10 text-center">
            ...
            <h2 class="mt-4 font-serif text-3xl text-ink">{{ __('Welcome') }}</h2>
            ...
            <div class="mt-8 flex justify-center gap-4">
                ...
                <a href="https://www.google.com" class="border border-stone-soft px-8 py-3 text-xs uppercase tracking-[0.2em] text-stone-500 transition hover:border-ink">{{ __('No') }}</a>
            </div>
        </div>
    </div>
@endunless
