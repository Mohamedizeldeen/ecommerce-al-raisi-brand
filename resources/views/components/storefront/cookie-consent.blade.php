<div x-data="cookieConsent" x-show="show" x-cloak
    ...
    <p class="font-serif text-lg text-ink">{{ __('We value your privacy') }}</p>
    <p class="mt-2 text-sm leading-relaxed text-stone-600">
        {{ __('We use cookies to enhance your experience and understand what you love, so we can serve you better.') }}
        <a href="{{ route('pages.privacy') }}" class="text-accent underline transition hover:text-accent-dark">{{ __('Learn more') }}</a>.
    </p>
